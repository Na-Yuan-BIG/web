...
function prependHeaderSection() {
    $('head').append("<link rel='stylesheet' type='text/css' href='" + "https://bigd.big.ac.cn/cgwas/css/page.min.css'>");
    var header = "<header>" +
        ...
        "<span class='bigd-icon-bar'></span> " +
        "</button> " +
        "<a href='" + bigd_site + "' class='bigd-navbar-brand'><img src='https://bigd.big.ac.cn/cdn/image/ngdc-logo.png' style='margin-right: 5px' /></a>" +
        "</div>" +
...
function appendFooterSection() {
    ...
    var footer = "" +
        ...
        "<a href='" + bigd_site + "'><img src='https://bigd.big.ac.cn/cdn/image/ngdc-logo-blue.png'  style='margin-top: 15px; margin-right: 10px'/></a> " +

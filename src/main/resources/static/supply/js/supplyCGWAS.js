...
function boom(iter){
    ...
    //---------------------
    //####################
    //result = selectgene(boom_chr[0], loca_start , loca_end);
    loading(svg , padding,height);
    //暂停，等待基因信息加载
...
function selectano(chr,bp){
    ...
    $.ajax({
        ...
        // url:'http://192.168.118.86:9888/cgwas/variant',
        type: "post",
        dataType: "json",
        async: false,
        cache:false,
...
function selectgene(chr,start,end){
    ...
    $.ajax({
        ...
        // url:'http://192.168.118.86:9888/cgwas/gene',
        type: "post",
        dataType: "json",
        async: false,
        cache:false,
...
function loadcgwas(userid){
    ...
    cgwasdata = cgwasdata.split("\n");
    for(var i = 0;i<cgwasdata.length;i++){

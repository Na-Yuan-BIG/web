...
<nav class="navbar navbar-default" style="background-color: #FFF;color: #337ab7;box-shadow:0px 2px 0 rgba(52, 130, 193, 0.75)">
    <div class="container" id="nav_container" style="background-color: #FFF;color: #337ab7">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://bigd.big.ac.cn/cgwas" style="padding-top: 0px;padding-bottom: 0px">
                <%--<img th:src="@{/pic/title.png}" class="img-responsive" style="height: 100%;">--%>
                    <img src="${host}/css/logo.jpg" class="img-rounded" style="margin-left:0px;height:90%">
            </a>
        </div>
...
<%--&lt;%&ndash;<header style="background:url('${host}/img/web.png') no-repeat; background-color: #5db4b5;background-position: 100% 8%">&ndash;%&gt;--%>

    <%--&lt;%&ndash;&lt;%&ndash;<header style="background: url('${host}/img/pop3.jpg') no-repeat; background-color: #008B8B;>&ndash;%&gt;&ndash;%&gt;--%>
    <%--&lt;%&ndash;<div class="page-header" style="border-bottom: none">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<h1 style=" color: #ffffff;font-size: 42px"><%=db_name%><br/>&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;<small style="color:#fafafa;font-size:20px;"><%=db_desc%>&ndash;%&gt;&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;</small>&ndash;%&gt;</h1>&ndash;%&gt;--%>
    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
